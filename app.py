...
if "attempts" not in st.session_state:
    # Was 1, which made the first game's "Attempts left" one lower than
    # every game started with New Game. Both are 0 now.
...
if new_game:
    # FIX (New Game did nothing): this block reset attempts and secret but
    # left status, score and history alone, so after a win or loss the
